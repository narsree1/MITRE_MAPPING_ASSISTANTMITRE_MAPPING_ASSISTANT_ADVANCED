...
# Analytics page
    ...
    if st.session_state.mapping_complete and st.session_state.processed_data is not None:
        ...
        # Normalize tactic names to avoid duplicates like "Command And Control" vs "Command-and-control"
        ...
        # Process techniques to handle comma-separated techniques properly
        ...
        if processed_techniques_count:
            ...
            # Also update the session state techniques_count for other pages
